...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        list1.add(100); list1.add(500); list1.add(900);
        list2.add(800); list2.add(600); list2.add(300);
        list3.add(400); list3.add(700); list3.add(200);

        ArrayOrganizer arrayOrganizer = new ArrayOrganizer();
        ArrayList<Integer> result = arrayOrganizer.concatAndSort(
                list1, list2, list3);
